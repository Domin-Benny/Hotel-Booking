...
var book_components_1 = __importDefault(require("./components/book.components"));
...
var Book = function () {
    return (react_1.default.createElement("div", { className: "relative w-screen h-max min-h-screen bg-blue-50 overflow-hidden" },
        ...
        react_1.default.createElement("div", { className: " w- h-max flex relative flex-col justify-center items-center " },
            react_1.default.createElement(header_1.default, null),
            react_1.default.createElement(book_components_1.default, null),
