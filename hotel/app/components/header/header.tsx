  ...
  return (
    <header className=" w-screen h-[100px] flex justify-center items-center " >
      <div className=" relative flex justify-center items-center h-[100px] w-11/12 ">
        ...
        <div className="  absolute left-[1rem] w-max p-5 -mt-5 pb-3 rounded-b-2xl bg-white border-2 border-blue-500 ">
          <Link href="/">
        ...
        <div className="  absolute right-[1rem] h-[110px] top- -m-5 w-max  p-5 flex items-end justify-center rounded-b-2xl bg-white border-2 border-blue-500 ">
          <Link href="/book" className=" text-black px-3 py-2 hover:bg-blue-800 hover:text-white transition duration-300 ease-in-out rounded-sm  ">
